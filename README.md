...
R.LUX 런칭 등 다양한 비즈니스 프로젝트에 참여했습니다.

### Platform

쿠팡 iOS 프로젝트의 기반 기능 개선 및 유지보수 업무를 진행했습니다.
...
쿠팡의 디자인 시스템 구축 프로젝트에 참여했습니다. iOS 환경에서 사용할 수 있는 UI 라이브러리를 만들고 유지보수 하였으며, 쿠팡 iOS 애플리케이션에 적용했습니다.
